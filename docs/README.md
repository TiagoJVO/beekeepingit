...
| Path | Contents |
|---|---|
| [architecture/](architecture/) | System architecture — HLD now (service decomposition, C4 views, data model, API contracts, auth/authz, sync & conflict resolution, history/audit), as-built as it's implemented |
