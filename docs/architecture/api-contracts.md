...
| Q-ROLE — **resolved** (revised by D-32)                                                         | `admin` is **org-scoped**; member/invitation endpoints are admin-only. A second, **platform** tier (cross-organization operator) is **planned**, not in the contract yet — EPIC-18 | [auth.md](auth.md) §5.3 / [ADR-0004](../adr/0004-authn-authz.md) (#109); platform tier: [#463](https://github.com/TiagoJVO/beekeepingit/issues/463) |
