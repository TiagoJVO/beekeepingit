...
- **And now at save time too (#597).** The same evaluator runs a **second** time, earlier: when the
  ...
  sheet). Not yet: the activity form, the DGAV stock declaration and the apiary counters — see the
...
- **Still open:** the three write paths #597 did not reach — the activity form, the DGAV stock
