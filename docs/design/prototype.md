...
> [`requirements/`](../../requirements/) (`FR-*`/`NFR-*`/`D-*`); this documents how that intent should _look and
> flow_. Where the two diverge, `requirements/` wins. It maps onto the existing **M0–M11** backlog (`D-14`) — it
