...
| [tech-stack.md](tech-stack.md)                                   | **Intended** technical approach/stack (revisitable; `docs/` tracks what's actually built). |
...
(`D-1`…`D-20` in [decisions.md](decisions.md)): scope, hive model, org invites, full
