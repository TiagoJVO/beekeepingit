...
const syncValidationRulesJson = r'''
{
  ...
  "serverOnly": [
    ...
    "The apiary 'patch must change at least one field' rule (services/apiaries/api/sync.go) — defined over an exact field list, so a field added server-side would make the client reject valid patches, for no user-visible benefit.",
