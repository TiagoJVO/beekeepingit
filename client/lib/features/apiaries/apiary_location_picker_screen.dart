          ...
          children: [
            ...
            Positioned(
              ...
              child: MapAttributionChip(
                ...
                textKey: const Key('apiary-fullscreen-picker-attribution'),
              ),
            ),
            // Recenter control (#420): only once a pin exists is there
            // anything to recenter on. [MapCircleControl] carries the
            // gloves-friendly shape (≥`kMinTapTarget`, Tooltip + Semantics
            // label, WCAG 2.2 AA) shared with the embedded picker (#444).
            if (location != null)
              Positioned(
                top: 12,
                right: 12,
