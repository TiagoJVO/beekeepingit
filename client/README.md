...
| `lib/routing/`              | [go_router](https://pub.dev/packages/go_router) config — `/login`, apiaries list (`/apiaries`), create/edit form (`/apiaries/new`, `/apiaries/:id`), with an auth redirect                                   |
